...
public class PoolManager : Singleton<PoolManager>
{
    ...
    public void PrintStatus()
    {
        foreach (var keyVal in prefabLookup)
            Debug.Log(
                ($"[Pool Manager] Object Pool for Prefab: {keyVal.Key.name} In Use: {keyVal.Value.CountUsedItems} Total {keyVal.Value.Count}"
                ));
    }
    ...
    public static void Release(GameObject clone, float t)
    {
